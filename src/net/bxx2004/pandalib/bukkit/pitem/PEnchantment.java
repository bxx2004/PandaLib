...
import net.bxx2004.pandalib.bukkit.plistener.event.PEnchantRegisterEvent;
...
public abstract class PEnchantment{
    static {
        ...
        method.InPutName("registerEnchantments").InPutArg(null).run(null);
    }
     ...
     * @return 附魔书物品堆
     */
    public abstract PItemStack getEnchantBook();
     ...
     * @return 应用物品
     */
    public PItemStack[] getCustomItem(){
        return null;
    };
    /**
     * 注册该附魔
